...
def wrap_text(text: Any, width: int = ..., initial_indent: str = ..., subsequent_indent: str = ..., preserve_paragraphs: bool = ...): ...
...
class HelpFormatter:
    ...
    current_indent: int = ...
    buffer: Any = ...
    def __init__(self, indent_increment: int = ..., width: Optional[Any] = ..., max_width: Optional[Any] = ...) -> None: ...
    ...
    def write_dl(self, rows: Any, col_max: int = ..., col_spacing: int = ...) -> None: ...
